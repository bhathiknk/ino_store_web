            ...
            <div className="flex flex-col min-h-screen">
                ...
                <main className="flex-grow">
                    ...
                    <div className="container mx-auto p-6">
                        <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">My Orders</h1>
                                ...
                                {orders.map((order) => (
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-800 mb-2">
                                            <span className="font-semibold">Total Amount:</span> LKR {order.totalAmount}
                                        </p>
                                        <p className="text-gray-800 mb-2">
                                        ...
                                        <p className="text-gray-800 mb-4">
                                            <span className="font-semibold">Placed On:</span> {new Date(order.createdAt).toLocaleDateString()}
                                        </p>
