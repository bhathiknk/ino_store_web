...
import { FaTshirt, FaHandHoldingHeart, FaGem, FaHome, FaUtensils, FaSpa, FaGamepad, FaPenFancy, FaGift, FaPaintBrush } from 'react-icons/fa';
    ...
    <div className="w-64 p-4">
      <ul>
        {categories.map((category, index) => (
          <li key={index} className="flex items-center py-2 px-4 text-gray-700 hover:text-blue-600 cursor-pointer">
